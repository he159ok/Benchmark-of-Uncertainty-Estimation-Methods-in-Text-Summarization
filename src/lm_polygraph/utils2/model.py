...
from src.lm_polygraph.utils2.generation_parameters import GenerationParameters
from src.lm_polygraph.utils2.prompt_templates.llama import LlamaPromptTemplate
from src.lm_polygraph.utils2.prompt_templates.vicuna import get_vicuna_prompt
from src.lm_polygraph.utils2.ensemble_utils.ensemble_generator import EnsembleGenerationMixin
from src.lm_polygraph.utils2.ensemble_utils.dropout import replace_dropout
    ...
    def generate_texts(self, input_texts: List[str], **args) -> List[str]:
        ...
        for key, replace_key in [
            ...
            if key in args.keys():
                ...
                args.pop(key)
        texts = []
        print(f"args in blackbox mode is {args}")
...
class WhiteboxModel(Model):
    ...
    def from_pretrained(model_path: str, device: str = "cpu", **kwargs):
        ...
        if 'llama' in model_path:
            ...
            #     device_map={"": 0}, # need to revise in the figure
            #     trust_remote_code=True,
            #     torch_dtype=torch.float16,
            #     use_auth_token='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',
            # )
