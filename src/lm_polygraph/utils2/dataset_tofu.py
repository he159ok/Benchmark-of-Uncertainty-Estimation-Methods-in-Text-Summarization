...
class Dataset_Tofu:
    ...
    def from_csv(
        ...
        **kwargs
        ...
        pre_ei = 1 - csv[ei_name] * 1.0
        pre_mr = 1 - csv[mr_name] * 1.0
        pre_so = 1 - csv[so_name] * 1.0
        pre_re = 1 - csv[re_name] * 1.0
        pre_tme = 1 - csv[tme_name] * 1.0
        pre_co = 1 - csv[co_name] * 1.0
        pre_nms = 1 - csv[nms_name] * 1.0
