...
class UniEval_Coherence(GenerationMetric):


    def __init__(self, task='summarization', selected_key = 'coherence', file_name ='./assist_res/unieval_res.json', depend=["greedy_texts"]):
        """
        Parameters:
