...
class UniEval_Fluency(GenerationMetric):


    def __init__(self, task='summarization', selected_key = 'fluency', file_name ='./assist_res/unieval_res.json', depend=["greedy_texts"]):
