...
class UniEval_Relevance(GenerationMetric):


    def __init__(self, task='summarization', selected_key = 'relevance', file_name ='./assist_res/unieval_res.json', depend=["greedy_texts"]):
